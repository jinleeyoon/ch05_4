...
const ListCard:FC<ListCardProps> = ({card,onRemove,onClick,draggableId,index})=>{
  ...
  <Div className="m-2 overflow-hidden border shadow-lg rounded-xl" width='10rem' onClick={onClick}>
   <Div src={image} className='relative h-20'>
    <Icon name='remove' className='absolute right-1 top-1 btn-primary btn-xs' onClick={onRemove}/>
   </Div>
