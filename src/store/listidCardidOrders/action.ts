...
export const prependCardidToListid = (payload:CT.ListidCardid):T.PrependCardidToListidAction => ({
  type:'@listidCardids/prependCardid',
  payload
})
export const appendCardidToListid = (payload:CT.ListidCardid):T.AppendCardidToListidAction => ({
  type:'@listidCardids/appendCardid',
  payload
})
export const removeCardidFromListid= (payload:CT.ListidCardid):T.RemoveCardidFromListidAction => ({
